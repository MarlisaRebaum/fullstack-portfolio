          ...
          <div className={classes.content}>
            ...
            <div className={classes.aboutText}>
              <Typography className={classes.text}>
                  ...
                  full stack web development bootcamp and finally found my missing 
                  puzzle piece. I realized that on my strive for a career I was 
                  passionate about, I was missing the opportunity for endless 
                  ...
                  interfaces and code possible. I am excited for an opportunity 
                  to use my honed soft skills from teaching combined with my 
                  technical skills learned from Coding Temple's bootcamp to start
